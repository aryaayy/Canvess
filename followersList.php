<?php
  ...
  if(isset($_SESSION['session_id_user'])){
    ...
    $followersList = readAllFollowers($id_user);
    $countFollowers = countFollowers($id_user);
    $countFollowersAcc = countFollowersAcc($id_user);
    $followersAcc = readFollowersAcc($id_user);
  }else{
        ...
        <div class="row">
          <div class="col-lg-12 d-flex justify-content-center" data-aos="fade-up" data-aos-delay="100">
            <ul id="portfolio-flters">
              <li data-filter="*" class="filter-active">All (<?= $countFollowers+$countFollowersAcc; ?>)</li>
              <?php
                if($user['id_postprivacy'] == 1){
              ?>
              <li data-filter=".filter-accepted" >Accepted (<?= $countFollowers; ?>)</li>
              <li data-filter=".filter-pending" >Pending (<?= $countFollowersAcc; ?>)</li>
              <?php } ?>
        ...
        <div class="row portfolio-container" data-aos="fade-up" data-aos-delay="200">
          <?php
            foreach($followersList as $followers){
                $follower = readUserProfile($followers['id_follower']);
          ?>
          <div class="col-lg-4 col-md-6 portfolio-item filter-accepted">
            <div class="col">
              <div class="card h-100">
                <a href="seeProfile.php?username=<?= $follower['username']?>">
                  <div class="card-body">
                  ...
                  <div class="card-footer">
                    <?php
                      if($id_user == $followers['id_followed']){
                    ?>
                    <div class="rep-btn">
                      <a href="deleteFollower.php?id_follower=<?=$follower['id_user']?>" onclick="return confirm('You are going to remove this person as a follower')"><i class="bi bi-trash"></i></a>
                    </div>
                    <?php
                      }
                    ?>
          ...
          <?php
            ...
            foreach($followersAcc as $followers){
                $follower = readUserProfile($followers['id_follower']);
          ?>
          <div class="col-lg-4 col-md-6 portfolio-item filter-pending">
            <div class="col">
              <div class="card h-100">
                <a href="seeProfile.php?username=<?= $follower['username']?>">
                  <div class="card-body">
                  ...
                  <div class="card-footer">
                    ...
                    ?>
                    <div class="rep-btn">
                        <a href="followersAcc.php?id_follower=<?=$follower['id_user']?>" onclick="return confirm('You are going to accept this person as a follower')">Accept</a>
                        &nbsp;&nbsp;
                        <a href="deleteFollower.php?id_follower=<?=$follower['id_user']?>" onclick="return confirm('You are going to reject this person as a follower')">Reject</a>
                    </div>
                    <?php
                      }
                    ?>
