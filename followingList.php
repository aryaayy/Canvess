<?php
  ...
  if(isset($_SESSION['session_id_user'])){
    ...
    $followingList = readAllFollowing($id_user);
    $countFollowing = countFollowing($id_user);
  }else{
        ...
        <div class="row">
          <div class="col-lg-12 d-flex justify-content-center" data-aos="fade-up" data-aos-delay="100">
            <ul id="portfolio-flters">
              <li data-filter="*" class="filter-active">All (<?= $countFollowing; ?>)</li>
        ...
        <div class="row portfolio-container" data-aos="fade-up" data-aos-delay="200">
          <?php
            foreach($followingList as $following){
              $followed = readUserProfile($following['id_followed']);
          ?>
          <div class="col-lg-4 col-md-6 portfolio-item filter-main filter-all">
            <div class="col">
              <div class="card h-100">
                <a href="seeProfile.php?username=<?= $followed['username']?>">
                  <div class="card-body">
                  ...
                  <div class="card-footer">
                    <?php
                      if($id_user == $following['id_follower']){
                    ?>
                    <div class="rep-btn">
                      <?php
                        if($followed['id_postprivacy'] == 0){
                      ?>
                      <a href="deleteFollowing.php?id_followed=<?=$followed['id_user']?>" onclick="return confirm('You are going to unfollow this person')"><i class="bi bi-trash"></i></a>
                      <?php
                        }else{
                      ?>
                      <a href="deleteFollowing.php?id_followed=<?=$followed['id_user']?>" onclick="return confirm('Are you sure? You will have to request again after unfollowing')"><i class="bi bi-trash"></i></a>
                      <?php } ?>
                    </div>
                    <?php
                      }
