                ...
                <div class="row">
                  <div class="col-lg-12 d-flex justify-content-center" data-aos="fade-up" data-aos-delay="100">
                    <ul id="portfolio-flters">
                      <div class="edit-box border rounded">
                        <li><a href="editProfile.php" class="mt-1 normal">Edit Profile</a></li>
                      </div>
                      <br>
                      <li><a href="followingList.php" class="normal">Following</a></li>
                      <li><a href="followersList.php" class="normal">Followers</a></li>
                      <br>
                      <br>
                      <li><a href="likedposts.php" class="normal">Liked posts</a></li>
                      <li><a href="postandreply.php" class="normal">Posts & Replies</a></li>
                    </ul>
                  </div>
                </div>
              </div>
