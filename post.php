            ...
            <div class="card">
                ...
                <ul class="list-group list-group-flush">
                    ...
                    <li class="list-group-item">
                        ...
                        ?>
                        <a href="deleteReply.php?id_replychat=<?=$reply['id_replychat']?>&id_mainchat=<?=$id_mainchat?>&type=2" onclick="return confirm('You are going to delete a post')"><i class="bi bi-trash" style="color:red;"></i></a>
                        <?php
                            }
                        ?>
...
<script src="https://ajax.googleapis.com/ajax/libs/jquery/3.6.4/jquery.min.js"></script>
  ...
  likeBtn.forEach(likeButton => {
    ...
    likeButton.addEventListener('click', (event) => {
        ...
        $.ajax({
            url: "likes.php", // Replace with your server-side script URL
            type: "POST",
            data: formData,
