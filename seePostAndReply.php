<?php
  ...
  if(isset($_SESSION['session_id_user'])){
    ...
    if($followAccCheck == 1 || $user['id_postprivacy'] == 0){
      $user_auth = $_SESSION['authority'];
      $session_user = readUserProfile($id_user);
      $countMain = countMainChatProfilePublic($id_user_visit);
      $countReply = countReplyChatProfilePublic($id_user_visit);
      $main = readMainChatProfile($id_user_visit);
      $reply = readReplyChatProfile($id_user_visit);
    }else{
      echo "
        <script>
...
<section id="portfolio" class="portfolio section-bg">
      ...
      <div class="section-title">
          <h2><?=$user['username']?>'S POSTS & REPLIES</h2>
        </div>
              ...
              <div class="card h-100">
                <div class="card-body">
                  <h5 class="card-title">
                        ...
                        ?>
                        <a href="seeProfile.php?username=<?=$chat['username']?>">
                        <?php
                          }else{
                        ?>
                          <a href="profile.php">
