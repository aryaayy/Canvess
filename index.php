              ...
              <div class="card-footer">
                ...
                <?php
                  ...
                  <div class="rep-btn">
                    ...
                    <a href="deletePost.php?id_mainchat=<?=$chat['id_mainchat']?>&type=1" onclick="return confirm('You are going to delete a post')"><i class="bi bi-trash"></i></a>
                  </div>
                  <?php
                    }
                    ?>
