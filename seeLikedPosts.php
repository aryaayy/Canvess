<?php
  ...
  if(isset($_SESSION['session_id_user'])){
    ...
    if($followAccCheck == 1 || $user['id_postprivacy'] == 0){
      ...
      $likedPosts = readLikedMainChat($id_user_visit);
      $countLiked = countLikedMainChat($id_user_visit);
    }else{
      echo "
        <script>
                ...
                <div class="card-body">
                  <?php
                    ...
                    ?>
                        <h5 class="card-title">
                        <?php
                          if($main['id_user'] != $id_user){
                        ?>
                        <a href="seeProfile.php?username=<?=$main['username']?>">
                        <?php
                          }else{
                        ?>
                          <a href="profile.php">
